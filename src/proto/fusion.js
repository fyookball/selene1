...
$root.fusion = (function() {
    ...
    fusion.InputComponent = (function() {
         ...
         * @instance
         */
        InputComponent.prototype.amount = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
        ...
        InputComponent.decode = function decode(reader, length, error) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.InputComponent();
            ...
            if (!message.hasOwnProperty("prevTxid"))
                throw $util.ProtocolError("missing required 'prevTxid'", { instance: message });
        ...
        InputComponent.verify = function verify(message) {
            ...
            if (!(message.prevTxid && typeof message.prevTxid.length === "number" || $util.isString(message.prevTxid)))
        ...
        InputComponent.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.InputComponent)
                return object;
            var message = new $root.fusion.InputComponent();
            if (object.prevTxid != null)
                if (typeof object.prevTxid === "string")
                    $util.base64.decode(object.prevTxid, message.prevTxid = $util.newBuffer($util.base64.length(object.prevTxid)), 0);
        ...
        InputComponent.toObject = function toObject(message, options) {
            ...
            if (message.prevTxid != null && message.hasOwnProperty("prevTxid"))
                object.prevTxid = options.bytes === String ? $util.base64.encode(message.prevTxid, 0, message.prevTxid.length) : options.bytes === Array ? Array.prototype.slice.call(message.prevTxid) : message.prevTxid;
    ...
    fusion.OutputComponent = (function() {
         ...
         * @instance
         */
        OutputComponent.prototype.amount = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
         ...
         * @returns {$protobuf.Writer} Writer
         */
        OutputComponent.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        OutputComponent.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.OutputComponent();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        OutputComponent.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.OutputComponent)
                return object;
            var message = new $root.fusion.OutputComponent();
    ...
    fusion.BlankComponent = (function() {
        ...
        BlankComponent.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.BlankComponent();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        BlankComponent.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.BlankComponent)
                return object;
    ...
    fusion.Component = (function() {
        ...
        Component.encode = function encode(message, writer) {
            ...
            if (message.input != null && Object.hasOwnProperty.call(message, "input"))
                $root.fusion.InputComponent.encode(message.input, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.output != null && Object.hasOwnProperty.call(message, "output"))
                $root.fusion.OutputComponent.encode(message.output, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.blank != null && Object.hasOwnProperty.call(message, "blank"))
                $root.fusion.BlankComponent.encode(message.blank, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };
        ...
        Component.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.Component();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 2: {
                        message.input = $root.fusion.InputComponent.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
                        message.output = $root.fusion.OutputComponent.decode(reader, reader.uint32());
                        break;
                    }
                case 4: {
                        message.blank = $root.fusion.BlankComponent.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
            ...
            if (!message.hasOwnProperty("saltCommitment"))
                throw $util.ProtocolError("missing required 'saltCommitment'", { instance: message });
            return message;
        };
        ...
        Component.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            var properties = {};
            if (!(message.saltCommitment && typeof message.saltCommitment.length === "number" || $util.isString(message.saltCommitment)))
                return "saltCommitment: buffer expected";
            if (message.input != null && message.hasOwnProperty("input")) {
                properties.component = 1;
                {
                    var error = $root.fusion.InputComponent.verify(message.input);
                    if (error)
                        return "input." + error;
                }
            }
            if (message.output != null && message.hasOwnProperty("output")) {
                if (properties.component === 1)
                    return "component: multiple values";
                properties.component = 1;
                {
                    var error = $root.fusion.OutputComponent.verify(message.output);
                    if (error)
                        return "output." + error;
                }
            }
            if (message.blank != null && message.hasOwnProperty("blank")) {
                ...
                properties.component = 1;
                {
                    var error = $root.fusion.BlankComponent.verify(message.blank);
                    if (error)
                        return "blank." + error;
                }
            }
        ...
        Component.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.Component)
                return object;
            var message = new $root.fusion.Component();
            if (object.saltCommitment != null)
                if (typeof object.saltCommitment === "string")
                    $util.base64.decode(object.saltCommitment, message.saltCommitment = $util.newBuffer($util.base64.length(object.saltCommitment)), 0);
        ...
        Component.toObject = function toObject(message, options) {
            ...
            if (message.saltCommitment != null && message.hasOwnProperty("saltCommitment"))
                object.saltCommitment = options.bytes === String ? $util.base64.encode(message.saltCommitment, 0, message.saltCommitment.length) : options.bytes === Array ? Array.prototype.slice.call(message.saltCommitment) : message.saltCommitment;
            if (message.input != null && message.hasOwnProperty("input")) {
                object.input = $root.fusion.InputComponent.toObject(message.input, options);
                if (options.oneofs)
                    object.component = "input";
            }
            if (message.output != null && message.hasOwnProperty("output")) {
                object.output = $root.fusion.OutputComponent.toObject(message.output, options);
                if (options.oneofs)
                    object.component = "output";
            }
            if (message.blank != null && message.hasOwnProperty("blank")) {
                object.blank = $root.fusion.BlankComponent.toObject(message.blank, options);
                if (options.oneofs)
                    object.component = "blank";
            }
            return object;
        };
    ...
    fusion.InitialCommitment = (function() {
        ...
        InitialCommitment.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.saltedComponentHash);
         ...
         * @returns {$protobuf.Writer} Writer
         */
        InitialCommitment.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        InitialCommitment.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.InitialCommitment();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
            ...
            if (!message.hasOwnProperty("saltedComponentHash"))
                throw $util.ProtocolError("missing required 'saltedComponentHash'", { instance: message });
            if (!message.hasOwnProperty("amountCommitment"))
                throw $util.ProtocolError("missing required 'amountCommitment'", { instance: message });
            if (!message.hasOwnProperty("communicationKey"))
                throw $util.ProtocolError("missing required 'communicationKey'", { instance: message });
            return message;
        };
        ...
        InitialCommitment.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (!(message.saltedComponentHash && typeof message.saltedComponentHash.length === "number" || $util.isString(message.saltedComponentHash)))
                return "saltedComponentHash: buffer expected";
            if (!(message.amountCommitment && typeof message.amountCommitment.length === "number" || $util.isString(message.amountCommitment)))
                return "amountCommitment: buffer expected";
            if (!(message.communicationKey && typeof message.communicationKey.length === "number" || $util.isString(message.communicationKey)))
        ...
        InitialCommitment.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.InitialCommitment)
                return object;
            var message = new $root.fusion.InitialCommitment();
            if (object.saltedComponentHash != null)
                if (typeof object.saltedComponentHash === "string")
                    $util.base64.decode(object.saltedComponentHash, message.saltedComponentHash = $util.newBuffer($util.base64.length(object.saltedComponentHash)), 0);
            ...
            if (object.amountCommitment != null)
                if (typeof object.amountCommitment === "string")
                    $util.base64.decode(object.amountCommitment, message.amountCommitment = $util.newBuffer($util.base64.length(object.amountCommitment)), 0);
            ...
            if (object.communicationKey != null)
                if (typeof object.communicationKey === "string")
                    $util.base64.decode(object.communicationKey, message.communicationKey = $util.newBuffer($util.base64.length(object.communicationKey)), 0);
        ...
        InitialCommitment.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                if (options.bytes === String)
                    ...
                    object.saltedComponentHash = [];
                    if (options.bytes !== Array)
                        object.saltedComponentHash = $util.newBuffer(object.saltedComponentHash);
                }
                if (options.bytes === String)
            ...
            if (message.saltedComponentHash != null && message.hasOwnProperty("saltedComponentHash"))
                object.saltedComponentHash = options.bytes === String ? $util.base64.encode(message.saltedComponentHash, 0, message.saltedComponentHash.length) : options.bytes === Array ? Array.prototype.slice.call(message.saltedComponentHash) : message.saltedComponentHash;
            if (message.amountCommitment != null && message.hasOwnProperty("amountCommitment"))
                object.amountCommitment = options.bytes === String ? $util.base64.encode(message.amountCommitment, 0, message.amountCommitment.length) : options.bytes === Array ? Array.prototype.slice.call(message.amountCommitment) : message.amountCommitment;
            if (message.communicationKey != null && message.hasOwnProperty("communicationKey"))
                object.communicationKey = options.bytes === String ? $util.base64.encode(message.communicationKey, 0, message.communicationKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.communicationKey) : message.communicationKey;
            return object;
        };
    ...
    fusion.Proof = (function() {
        ...
        Proof.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.Proof();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
            ...
            if (!message.hasOwnProperty("componentIdx"))
                throw $util.ProtocolError("missing required 'componentIdx'", { instance: message });
            ...
            if (!message.hasOwnProperty("pedersenNonce"))
                throw $util.ProtocolError("missing required 'pedersenNonce'", { instance: message });
            return message;
        };
        ...
        Proof.verify = function verify(message) {
            ...
            if (!(message.pedersenNonce && typeof message.pedersenNonce.length === "number" || $util.isString(message.pedersenNonce)))
        ...
        Proof.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.Proof)
                return object;
            var message = new $root.fusion.Proof();
            ...
            if (object.pedersenNonce != null)
                if (typeof object.pedersenNonce === "string")
                    $util.base64.decode(object.pedersenNonce, message.pedersenNonce = $util.newBuffer($util.base64.length(object.pedersenNonce)), 0);
        ...
        Proof.toObject = function toObject(message, options) {
            ...
            if (message.componentIdx != null && message.hasOwnProperty("componentIdx"))
            ...
            if (message.pedersenNonce != null && message.hasOwnProperty("pedersenNonce"))
                object.pedersenNonce = options.bytes === String ? $util.base64.encode(message.pedersenNonce, 0, message.pedersenNonce.length) : options.bytes === Array ? Array.prototype.slice.call(message.pedersenNonce) : message.pedersenNonce;
            return object;
        };
    ...
    fusion.ClientHello = (function() {
        ...
        ClientHello.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.ClientHello();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        ClientHello.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.ClientHello)
                return object;
            var message = new $root.fusion.ClientHello();
    ...
    fusion.ServerHello = (function() {
         ...
         * @instance
         */
        ServerHello.prototype.componentFeerate = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
         ...
         * @instance
         */
        ServerHello.prototype.minExcessFee = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
         ...
         * @instance
         */
        ServerHello.prototype.maxExcessFee = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
        ...
        ServerHello.encode = function encode(message, writer) {
            ...
            writer.uint32(/* id 4, wireType 0 =*/32).uint64(message.componentFeerate);
            writer.uint32(/* id 5, wireType 0 =*/40).uint64(message.minExcessFee);
            writer.uint32(/* id 6, wireType 0 =*/48).uint64(message.maxExcessFee);
            if (message.donationAddress != null && Object.hasOwnProperty.call(message, "donationAddress"))
                writer.uint32(/* id 15, wireType 2 =*/122).string(message.donationAddress);
            return writer;
        };
        ...
        ServerHello.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.ServerHello();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 1: {
                        ...
                        if ((tag & 7) === 2) {
                            ...
                            while (reader.pos < end2)
                                message.tiers.push(reader.uint64());
                        } else
                            message.tiers.push(reader.uint64());
                        break;
                    }
            ...
            if (!message.hasOwnProperty("numComponents"))
                throw $util.ProtocolError("missing required 'numComponents'", { instance: message });
            if (!message.hasOwnProperty("componentFeerate"))
                throw $util.ProtocolError("missing required 'componentFeerate'", { instance: message });
            if (!message.hasOwnProperty("minExcessFee"))
                throw $util.ProtocolError("missing required 'minExcessFee'", { instance: message });
            if (!message.hasOwnProperty("maxExcessFee"))
                throw $util.ProtocolError("missing required 'maxExcessFee'", { instance: message });
            return message;
        };
        ...
        ServerHello.verify = function verify(message) {
            ...
            if (message.tiers != null && message.hasOwnProperty("tiers")) {
                ...
                for (var i = 0; i < message.tiers.length; ++i)
                    if (!$util.isInteger(message.tiers[i]) && !(message.tiers[i] && $util.isInteger(message.tiers[i].low) && $util.isInteger(message.tiers[i].high)))
                        return "tiers: integer|Long[] expected";
            }
            if (!$util.isInteger(message.numComponents))
                return "numComponents: integer expected";
            if (!$util.isInteger(message.componentFeerate) && !(message.componentFeerate && $util.isInteger(message.componentFeerate.low) && $util.isInteger(message.componentFeerate.high)))
                return "componentFeerate: integer|Long expected";
            if (!$util.isInteger(message.minExcessFee) && !(message.minExcessFee && $util.isInteger(message.minExcessFee.low) && $util.isInteger(message.minExcessFee.high)))
                return "minExcessFee: integer|Long expected";
            if (!$util.isInteger(message.maxExcessFee) && !(message.maxExcessFee && $util.isInteger(message.maxExcessFee.low) && $util.isInteger(message.maxExcessFee.high)))
                return "maxExcessFee: integer|Long expected";
            if (message.donationAddress != null && message.hasOwnProperty("donationAddress"))
        ...
        ServerHello.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.ServerHello)
                return object;
            var message = new $root.fusion.ServerHello();
            if (object.tiers) {
                ...
                for (var i = 0; i < object.tiers.length; ++i)
                    if ($util.Long)
                        (message.tiers[i] = $util.Long.fromValue(object.tiers[i])).unsigned = true;
                        ...
                        message.tiers[i] = new $util.LongBits(object.tiers[i].low >>> 0, object.tiers[i].high >>> 0).toNumber(true);
            }
            if (object.numComponents != null)
                message.numComponents = object.numComponents >>> 0;
            if (object.componentFeerate != null)
                if ($util.Long)
                    (message.componentFeerate = $util.Long.fromValue(object.componentFeerate)).unsigned = true;
                    ...
                    message.componentFeerate = new $util.LongBits(object.componentFeerate.low >>> 0, object.componentFeerate.high >>> 0).toNumber(true);
            if (object.minExcessFee != null)
                if ($util.Long)
                    (message.minExcessFee = $util.Long.fromValue(object.minExcessFee)).unsigned = true;
                    ...
                    message.minExcessFee = new $util.LongBits(object.minExcessFee.low >>> 0, object.minExcessFee.high >>> 0).toNumber(true);
            if (object.maxExcessFee != null)
                if ($util.Long)
                    (message.maxExcessFee = $util.Long.fromValue(object.maxExcessFee)).unsigned = true;
                    ...
                    message.maxExcessFee = new $util.LongBits(object.maxExcessFee.low >>> 0, object.maxExcessFee.high >>> 0).toNumber(true);
        ...
        ServerHello.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                if ($util.Long) {
                    var long = new $util.Long(0, 0, true);
                    object.componentFeerate = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.componentFeerate = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, true);
                    object.minExcessFee = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.minExcessFee = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, true);
                    object.maxExcessFee = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.maxExcessFee = options.longs === String ? "0" : 0;
            ...
            if (message.tiers && message.tiers.length) {
                ...
                for (var j = 0; j < message.tiers.length; ++j)
                    if (typeof message.tiers[j] === "number")
                        object.tiers[j] = options.longs === String ? String(message.tiers[j]) : message.tiers[j];
                    else
                        object.tiers[j] = options.longs === String ? $util.Long.prototype.toString.call(message.tiers[j]) : options.longs === Number ? new $util.LongBits(message.tiers[j].low >>> 0, message.tiers[j].high >>> 0).toNumber(true) : message.tiers[j];
            }
            if (message.numComponents != null && message.hasOwnProperty("numComponents"))
                object.numComponents = message.numComponents;
            if (message.componentFeerate != null && message.hasOwnProperty("componentFeerate"))
                if (typeof message.componentFeerate === "number")
                    object.componentFeerate = options.longs === String ? String(message.componentFeerate) : message.componentFeerate;
                else
                    object.componentFeerate = options.longs === String ? $util.Long.prototype.toString.call(message.componentFeerate) : options.longs === Number ? new $util.LongBits(message.componentFeerate.low >>> 0, message.componentFeerate.high >>> 0).toNumber(true) : message.componentFeerate;
            if (message.minExcessFee != null && message.hasOwnProperty("minExcessFee"))
                if (typeof message.minExcessFee === "number")
                    object.minExcessFee = options.longs === String ? String(message.minExcessFee) : message.minExcessFee;
                else
                    object.minExcessFee = options.longs === String ? $util.Long.prototype.toString.call(message.minExcessFee) : options.longs === Number ? new $util.LongBits(message.minExcessFee.low >>> 0, message.minExcessFee.high >>> 0).toNumber(true) : message.minExcessFee;
            if (message.maxExcessFee != null && message.hasOwnProperty("maxExcessFee"))
                if (typeof message.maxExcessFee === "number")
                    object.maxExcessFee = options.longs === String ? String(message.maxExcessFee) : message.maxExcessFee;
                else
                    object.maxExcessFee = options.longs === String ? $util.Long.prototype.toString.call(message.maxExcessFee) : options.longs === Number ? new $util.LongBits(message.maxExcessFee.low >>> 0, message.maxExcessFee.high >>> 0).toNumber(true) : message.maxExcessFee;
            if (message.donationAddress != null && message.hasOwnProperty("donationAddress"))
    ...
    fusion.JoinPools = (function() {
        ...
        JoinPools.encode = function encode(message, writer) {
            ...
            if (message.tags != null && message.tags.length)
                for (var i = 0; i < message.tags.length; ++i)
                    $root.fusion.JoinPools.PoolTag.encode(message.tags[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            return writer;
        };
        ...
        JoinPools.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.JoinPools();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 2: {
                        if (!(message.tags && message.tags.length))
                            message.tags = [];
                        message.tags.push($root.fusion.JoinPools.PoolTag.decode(reader, reader.uint32()));
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        JoinPools.verify = function verify(message) {
            ...
            if (message.tags != null && message.hasOwnProperty("tags")) {
                ...
                for (var i = 0; i < message.tags.length; ++i) {
                    var error = $root.fusion.JoinPools.PoolTag.verify(message.tags[i]);
                    if (error)
                        return "tags." + error;
                }
            }
        ...
        JoinPools.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.JoinPools)
                return object;
            var message = new $root.fusion.JoinPools();
            if (object.tiers) {
                if (!Array.isArray(object.tiers))
            ...
            if (object.tags) {
                ...
                for (var i = 0; i < object.tags.length; ++i) {
                    ...
                    message.tags[i] = $root.fusion.JoinPools.PoolTag.fromObject(object.tags[i]);
                }
            }
            return message;
        };
        ...
        JoinPools.toObject = function toObject(message, options) {
            ...
            if (message.tags && message.tags.length) {
                ...
                for (var j = 0; j < message.tags.length; ++j)
                    object.tags[j] = $root.fusion.JoinPools.PoolTag.toObject(message.tags[j], options);
            }
            return object;
        };
        ...
        JoinPools.PoolTag = (function() {
            ...
            PoolTag.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.JoinPools.PoolTag();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            PoolTag.fromObject = function fromObject(object) {
                if (object instanceof $root.fusion.JoinPools.PoolTag)
                    return object;
                var message = new $root.fusion.JoinPools.PoolTag();
                if (object.id != null)
                ...
                if (object.noIp != null)
                    message.noIp = Boolean(object.noIp);
                return message;
            };
    ...
    fusion.TierStatusUpdate = (function() {
        ...
        TierStatusUpdate.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.statuses != null && Object.hasOwnProperty.call(message, "statuses"))
                for (var keys = Object.keys(message.statuses), i = 0; i < keys.length; ++i) {
                    writer.uint32(/* id 1, wireType 2 =*/10).fork().uint32(/* id 1, wireType 0 =*/8).uint64(keys[i]);
                    $root.fusion.TierStatusUpdate.TierStatus.encode(message.statuses[keys[i]], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim().ldelim();
                }
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        TierStatusUpdate.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        TierStatusUpdate.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.TierStatusUpdate(), key, value;
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        if (message.statuses === $util.emptyObject)
                            message.statuses = {};
                        var end2 = reader.uint32() + reader.pos;
                        key = 0;
                        value = null;
                        while (reader.pos < end2) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                value = $root.fusion.TierStatusUpdate.TierStatus.decode(reader, reader.uint32());
                                break;
                            default:
                        ...
                        message.statuses[typeof key === "object" ? $util.longToHash(key) : key] = value;
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        TierStatusUpdate.verify = function verify(message) {
            ...
            if (message.statuses != null && message.hasOwnProperty("statuses")) {
                ...
                var key = Object.keys(message.statuses);
                for (var i = 0; i < key.length; ++i) {
                    if (!$util.key64Re.test(key[i]))
                        return "statuses: integer|Long key{k:uint64} expected";
                    {
                        var error = $root.fusion.TierStatusUpdate.TierStatus.verify(message.statuses[key[i]]);
                        if (error)
        ...
        TierStatusUpdate.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.TierStatusUpdate)
                return object;
            var message = new $root.fusion.TierStatusUpdate();
            if (object.statuses) {
                if (typeof object.statuses !== "object")
                    throw TypeError(".fusion.TierStatusUpdate.statuses: object expected");
                message.statuses = {};
                for (var keys = Object.keys(object.statuses), i = 0; i < keys.length; ++i) {
                    if (typeof object.statuses[keys[i]] !== "object")
                        throw TypeError(".fusion.TierStatusUpdate.statuses: object expected");
                    message.statuses[keys[i]] = $root.fusion.TierStatusUpdate.TierStatus.fromObject(object.statuses[keys[i]]);
                }
            }
            return message;
        };
        ...
        TierStatusUpdate.toObject = function toObject(message, options) {
            ...
            if (message.statuses && (keys2 = Object.keys(message.statuses)).length) {
                ...
                for (var j = 0; j < keys2.length; ++j)
                    object.statuses[keys2[j]] = $root.fusion.TierStatusUpdate.TierStatus.toObject(message.statuses[keys2[j]], options);
            }
            return object;
        };
        ...
        TierStatusUpdate.TierStatus = (function() {
            ...
            TierStatus.encode = function encode(message, writer) {
                ...
                if (message.timeRemaining != null && Object.hasOwnProperty.call(message, "timeRemaining"))
                    writer.uint32(/* id 4, wireType 0 =*/32).uint32(message.timeRemaining);
                return writer;
            };
            ...
            TierStatus.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.TierStatusUpdate.TierStatus();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            TierStatus.fromObject = function fromObject(object) {
                if (object instanceof $root.fusion.TierStatusUpdate.TierStatus)
                    return object;
                var message = new $root.fusion.TierStatusUpdate.TierStatus();
    ...
    fusion.FusionBegin = (function() {
         ...
         * @instance
         */
        FusionBegin.prototype.tier = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
         ...
         * @instance
         */
        FusionBegin.prototype.serverTime = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        FusionBegin.encode = function encode(message, writer) {
            ...
            if (message.covertSsl != null && Object.hasOwnProperty.call(message, "covertSsl"))
        ...
        FusionBegin.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.FusionBegin();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
            ...
            if (!message.hasOwnProperty("tier"))
                throw $util.ProtocolError("missing required 'tier'", { instance: message });
            if (!message.hasOwnProperty("covertDomain"))
                throw $util.ProtocolError("missing required 'covertDomain'", { instance: message });
            if (!message.hasOwnProperty("covertPort"))
                throw $util.ProtocolError("missing required 'covertPort'", { instance: message });
        ...
        FusionBegin.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (!$util.isInteger(message.tier) && !(message.tier && $util.isInteger(message.tier.low) && $util.isInteger(message.tier.high)))
                return "tier: integer|Long expected";
            if (!(message.covertDomain && typeof message.covertDomain.length === "number" || $util.isString(message.covertDomain)))
        ...
        FusionBegin.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.FusionBegin)
                return object;
            var message = new $root.fusion.FusionBegin();
            if (object.tier != null)
                if ($util.Long)
                ...
                else if (typeof object.tier === "number")
                    message.tier = object.tier;
                else if (typeof object.tier === "object")
                    message.tier = new $util.LongBits(object.tier.low >>> 0, object.tier.high >>> 0).toNumber(true);
            if (object.covertDomain != null)
                if (typeof object.covertDomain === "string")
                    $util.base64.decode(object.covertDomain, message.covertDomain = $util.newBuffer($util.base64.length(object.covertDomain)), 0);
        ...
        FusionBegin.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                if ($util.Long) {
                    var long = new $util.Long(0, 0, true);
                    object.tier = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.tier = options.longs === String ? "0" : 0;
                if (options.bytes === String)
                    object.covertDomain = "";
                else {
                    object.covertDomain = [];
            ...
            if (message.tier != null && message.hasOwnProperty("tier"))
                if (typeof message.tier === "number")
                    object.tier = options.longs === String ? String(message.tier) : message.tier;
                else
                    object.tier = options.longs === String ? $util.Long.prototype.toString.call(message.tier) : options.longs === Number ? new $util.LongBits(message.tier.low >>> 0, message.tier.high >>> 0).toNumber(true) : message.tier;
            if (message.covertDomain != null && message.hasOwnProperty("covertDomain"))
                object.covertDomain = options.bytes === String ? $util.base64.encode(message.covertDomain, 0, message.covertDomain.length) : options.bytes === Array ? Array.prototype.slice.call(message.covertDomain) : message.covertDomain;
    ...
    fusion.StartRound = (function() {
         ...
         * @instance
         */
        StartRound.prototype.serverTime = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        StartRound.encode = function encode(message, writer) {
            ...
            if (message.blindNoncePoints != null && message.blindNoncePoints.length)
                for (var i = 0; i < message.blindNoncePoints.length; ++i)
                    writer.uint32(/* id 2, wireType 2 =*/18).bytes(message.blindNoncePoints[i]);
            writer.uint32(/* id 5, wireType 1 =*/41).fixed64(message.serverTime);
            return writer;
        };
        ...
        StartRound.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.StartRound();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
            ...
            if (!message.hasOwnProperty("roundPubkey"))
                throw $util.ProtocolError("missing required 'roundPubkey'", { instance: message });
            if (!message.hasOwnProperty("serverTime"))
                throw $util.ProtocolError("missing required 'serverTime'", { instance: message });
            return message;
        };
        ...
        StartRound.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (!(message.roundPubkey && typeof message.roundPubkey.length === "number" || $util.isString(message.roundPubkey)))
                return "roundPubkey: buffer expected";
            if (message.blindNoncePoints != null && message.hasOwnProperty("blindNoncePoints")) {
                if (!Array.isArray(message.blindNoncePoints))
                    return "blindNoncePoints: array expected";
                for (var i = 0; i < message.blindNoncePoints.length; ++i)
                    if (!(message.blindNoncePoints[i] && typeof message.blindNoncePoints[i].length === "number" || $util.isString(message.blindNoncePoints[i])))
        ...
        StartRound.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.StartRound)
                return object;
            var message = new $root.fusion.StartRound();
            if (object.roundPubkey != null)
                if (typeof object.roundPubkey === "string")
                    $util.base64.decode(object.roundPubkey, message.roundPubkey = $util.newBuffer($util.base64.length(object.roundPubkey)), 0);
            ...
            if (object.blindNoncePoints) {
                if (!Array.isArray(object.blindNoncePoints))
                    throw TypeError(".fusion.StartRound.blindNoncePoints: array expected");
                message.blindNoncePoints = [];
                for (var i = 0; i < object.blindNoncePoints.length; ++i)
                    if (typeof object.blindNoncePoints[i] === "string")
                        $util.base64.decode(object.blindNoncePoints[i], message.blindNoncePoints[i] = $util.newBuffer($util.base64.length(object.blindNoncePoints[i])), 0);
        ...
        StartRound.toObject = function toObject(message, options) {
            ...
            if (message.roundPubkey != null && message.hasOwnProperty("roundPubkey"))
                object.roundPubkey = options.bytes === String ? $util.base64.encode(message.roundPubkey, 0, message.roundPubkey.length) : options.bytes === Array ? Array.prototype.slice.call(message.roundPubkey) : message.roundPubkey;
            if (message.blindNoncePoints && message.blindNoncePoints.length) {
                object.blindNoncePoints = [];
                for (var j = 0; j < message.blindNoncePoints.length; ++j)
                    object.blindNoncePoints[j] = options.bytes === String ? $util.base64.encode(message.blindNoncePoints[j], 0, message.blindNoncePoints[j].length) : options.bytes === Array ? Array.prototype.slice.call(message.blindNoncePoints[j]) : message.blindNoncePoints[j];
            }
            if (message.serverTime != null && message.hasOwnProperty("serverTime"))
                if (typeof message.serverTime === "number")
                    object.serverTime = options.longs === String ? String(message.serverTime) : message.serverTime;
    ...
    fusion.PlayerCommit = (function() {
         ...
         * @instance
         */
        PlayerCommit.prototype.excessFee = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
        ...
        PlayerCommit.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.initialCommitments != null && message.initialCommitments.length)
                for (var i = 0; i < message.initialCommitments.length; ++i)
                    writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.initialCommitments[i]);
            writer.uint32(/* id 2, wireType 0 =*/16).uint64(message.excessFee);
            writer.uint32(/* id 3, wireType 2 =*/26).bytes(message.pedersenTotalNonce);
            writer.uint32(/* id 4, wireType 2 =*/34).bytes(message.randomNumberCommitment);
            if (message.blindSigRequests != null && message.blindSigRequests.length)
                for (var i = 0; i < message.blindSigRequests.length; ++i)
                    writer.uint32(/* id 5, wireType 2 =*/42).bytes(message.blindSigRequests[i]);
            return writer;
        };
        ...
        PlayerCommit.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.PlayerCommit();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
            ...
            if (!message.hasOwnProperty("excessFee"))
                throw $util.ProtocolError("missing required 'excessFee'", { instance: message });
            if (!message.hasOwnProperty("pedersenTotalNonce"))
                throw $util.ProtocolError("missing required 'pedersenTotalNonce'", { instance: message });
            if (!message.hasOwnProperty("randomNumberCommitment"))
                throw $util.ProtocolError("missing required 'randomNumberCommitment'", { instance: message });
            return message;
        };
        ...
        PlayerCommit.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.initialCommitments != null && message.hasOwnProperty("initialCommitments")) {
                if (!Array.isArray(message.initialCommitments))
                    return "initialCommitments: array expected";
                for (var i = 0; i < message.initialCommitments.length; ++i)
                    if (!(message.initialCommitments[i] && typeof message.initialCommitments[i].length === "number" || $util.isString(message.initialCommitments[i])))
                        return "initialCommitments: buffer[] expected";
            }
            if (!$util.isInteger(message.excessFee) && !(message.excessFee && $util.isInteger(message.excessFee.low) && $util.isInteger(message.excessFee.high)))
                return "excessFee: integer|Long expected";
            if (!(message.pedersenTotalNonce && typeof message.pedersenTotalNonce.length === "number" || $util.isString(message.pedersenTotalNonce)))
                return "pedersenTotalNonce: buffer expected";
            if (!(message.randomNumberCommitment && typeof message.randomNumberCommitment.length === "number" || $util.isString(message.randomNumberCommitment)))
                return "randomNumberCommitment: buffer expected";
            if (message.blindSigRequests != null && message.hasOwnProperty("blindSigRequests")) {
                if (!Array.isArray(message.blindSigRequests))
                    return "blindSigRequests: array expected";
                for (var i = 0; i < message.blindSigRequests.length; ++i)
                    if (!(message.blindSigRequests[i] && typeof message.blindSigRequests[i].length === "number" || $util.isString(message.blindSigRequests[i])))
        ...
        PlayerCommit.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.PlayerCommit)
                return object;
            var message = new $root.fusion.PlayerCommit();
            if (object.initialCommitments) {
                if (!Array.isArray(object.initialCommitments))
                    throw TypeError(".fusion.PlayerCommit.initialCommitments: array expected");
                message.initialCommitments = [];
                for (var i = 0; i < object.initialCommitments.length; ++i)
                    if (typeof object.initialCommitments[i] === "string")
                        $util.base64.decode(object.initialCommitments[i], message.initialCommitments[i] = $util.newBuffer($util.base64.length(object.initialCommitments[i])), 0);
            ...
            if (object.excessFee != null)
                if ($util.Long)
                    (message.excessFee = $util.Long.fromValue(object.excessFee)).unsigned = true;
                    ...
                    message.excessFee = new $util.LongBits(object.excessFee.low >>> 0, object.excessFee.high >>> 0).toNumber(true);
            if (object.pedersenTotalNonce != null)
                if (typeof object.pedersenTotalNonce === "string")
                    $util.base64.decode(object.pedersenTotalNonce, message.pedersenTotalNonce = $util.newBuffer($util.base64.length(object.pedersenTotalNonce)), 0);
            ...
            if (object.randomNumberCommitment != null)
                if (typeof object.randomNumberCommitment === "string")
                    $util.base64.decode(object.randomNumberCommitment, message.randomNumberCommitment = $util.newBuffer($util.base64.length(object.randomNumberCommitment)), 0);
            ...
            if (object.blindSigRequests) {
                if (!Array.isArray(object.blindSigRequests))
                    throw TypeError(".fusion.PlayerCommit.blindSigRequests: array expected");
                message.blindSigRequests = [];
                for (var i = 0; i < object.blindSigRequests.length; ++i)
                    if (typeof object.blindSigRequests[i] === "string")
                        $util.base64.decode(object.blindSigRequests[i], message.blindSigRequests[i] = $util.newBuffer($util.base64.length(object.blindSigRequests[i])), 0);
        ...
        PlayerCommit.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                if ($util.Long) {
                    var long = new $util.Long(0, 0, true);
                    object.excessFee = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.excessFee = options.longs === String ? "0" : 0;
                if (options.bytes === String)
                    object.pedersenTotalNonce = "";
                else {
                    object.pedersenTotalNonce = [];
                    if (options.bytes !== Array)
                        object.pedersenTotalNonce = $util.newBuffer(object.pedersenTotalNonce);
                }
                if (options.bytes === String)
                    ...
                    object.randomNumberCommitment = [];
                    if (options.bytes !== Array)
                        object.randomNumberCommitment = $util.newBuffer(object.randomNumberCommitment);
                }
            }
            if (message.initialCommitments && message.initialCommitments.length) {
                object.initialCommitments = [];
                for (var j = 0; j < message.initialCommitments.length; ++j)
                    object.initialCommitments[j] = options.bytes === String ? $util.base64.encode(message.initialCommitments[j], 0, message.initialCommitments[j].length) : options.bytes === Array ? Array.prototype.slice.call(message.initialCommitments[j]) : message.initialCommitments[j];
            }
            if (message.excessFee != null && message.hasOwnProperty("excessFee"))
                if (typeof message.excessFee === "number")
                    object.excessFee = options.longs === String ? String(message.excessFee) : message.excessFee;
                else
                    object.excessFee = options.longs === String ? $util.Long.prototype.toString.call(message.excessFee) : options.longs === Number ? new $util.LongBits(message.excessFee.low >>> 0, message.excessFee.high >>> 0).toNumber(true) : message.excessFee;
            if (message.pedersenTotalNonce != null && message.hasOwnProperty("pedersenTotalNonce"))
                object.pedersenTotalNonce = options.bytes === String ? $util.base64.encode(message.pedersenTotalNonce, 0, message.pedersenTotalNonce.length) : options.bytes === Array ? Array.prototype.slice.call(message.pedersenTotalNonce) : message.pedersenTotalNonce;
            if (message.randomNumberCommitment != null && message.hasOwnProperty("randomNumberCommitment"))
                object.randomNumberCommitment = options.bytes === String ? $util.base64.encode(message.randomNumberCommitment, 0, message.randomNumberCommitment.length) : options.bytes === Array ? Array.prototype.slice.call(message.randomNumberCommitment) : message.randomNumberCommitment;
            if (message.blindSigRequests && message.blindSigRequests.length) {
                object.blindSigRequests = [];
                for (var j = 0; j < message.blindSigRequests.length; ++j)
                    object.blindSigRequests[j] = options.bytes === String ? $util.base64.encode(message.blindSigRequests[j], 0, message.blindSigRequests[j].length) : options.bytes === Array ? Array.prototype.slice.call(message.blindSigRequests[j]) : message.blindSigRequests[j];
            }
            return object;
        };
    ...
    fusion.BlindSigResponses = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        BlindSigResponses.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        BlindSigResponses.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.BlindSigResponses();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        BlindSigResponses.verify = function verify(message) {
            ...
            if (message.scalars != null && message.hasOwnProperty("scalars")) {
                ...
                for (var i = 0; i < message.scalars.length; ++i)
                    if (!(message.scalars[i] && typeof message.scalars[i].length === "number" || $util.isString(message.scalars[i])))
        ...
        BlindSigResponses.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.BlindSigResponses)
                return object;
            var message = new $root.fusion.BlindSigResponses();
            if (object.scalars) {
                ...
                for (var i = 0; i < object.scalars.length; ++i)
                    if (typeof object.scalars[i] === "string")
                        $util.base64.decode(object.scalars[i], message.scalars[i] = $util.newBuffer($util.base64.length(object.scalars[i])), 0);
        ...
        BlindSigResponses.toObject = function toObject(message, options) {
            ...
            if (message.scalars && message.scalars.length) {
                ...
                for (var j = 0; j < message.scalars.length; ++j)
                    object.scalars[j] = options.bytes === String ? $util.base64.encode(message.scalars[j], 0, message.scalars[j].length) : options.bytes === Array ? Array.prototype.slice.call(message.scalars[j]) : message.scalars[j];
            }
            return object;
        };
    ...
    fusion.AllCommitments = (function() {
        ...
        AllCommitments.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.AllCommitments();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        AllCommitments.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.AllCommitments)
                return object;
            var message = new $root.fusion.AllCommitments();
            if (object.initialCommitments) {
                if (!Array.isArray(object.initialCommitments))
                    throw TypeError(".fusion.AllCommitments.initialCommitments: array expected");
                message.initialCommitments = [];
                for (var i = 0; i < object.initialCommitments.length; ++i)
                    if (typeof object.initialCommitments[i] === "string")
                        $util.base64.decode(object.initialCommitments[i], message.initialCommitments[i] = $util.newBuffer($util.base64.length(object.initialCommitments[i])), 0);
    ...
    fusion.CovertComponent = (function() {
        ...
        CovertComponent.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.roundPubkey != null && Object.hasOwnProperty.call(message, "roundPubkey"))
                writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.roundPubkey);
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CovertComponent.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        CovertComponent.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.CovertComponent();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
            ...
            if (!message.hasOwnProperty("component"))
                throw $util.ProtocolError("missing required 'component'", { instance: message });
            return message;
        };
        ...
        CovertComponent.verify = function verify(message) {
            ...
            if (!(message.component && typeof message.component.length === "number" || $util.isString(message.component)))
        ...
        CovertComponent.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.CovertComponent)
                return object;
            var message = new $root.fusion.CovertComponent();
            if (object.roundPubkey != null)
                if (typeof object.roundPubkey === "string")
                    $util.base64.decode(object.roundPubkey, message.roundPubkey = $util.newBuffer($util.base64.length(object.roundPubkey)), 0);
                else if (object.roundPubkey.length >= 0)
            ...
            if (object.component != null)
                if (typeof object.component === "string")
                    $util.base64.decode(object.component, message.component = $util.newBuffer($util.base64.length(object.component)), 0);
        ...
        CovertComponent.toObject = function toObject(message, options) {
            ...
            if (message.component != null && message.hasOwnProperty("component"))
                object.component = options.bytes === String ? $util.base64.encode(message.component, 0, message.component.length) : options.bytes === Array ? Array.prototype.slice.call(message.component) : message.component;
            return object;
        };
    ...
    fusion.ShareCovertComponents = (function() {
        ...
        ShareCovertComponents.encode = function encode(message, writer) {
            ...
            if (message.components != null && message.components.length)
                for (var i = 0; i < message.components.length; ++i)
                    writer.uint32(/* id 4, wireType 2 =*/34).bytes(message.components[i]);
            if (message.skipSignatures != null && Object.hasOwnProperty.call(message, "skipSignatures"))
                writer.uint32(/* id 5, wireType 0 =*/40).bool(message.skipSignatures);
            if (message.sessionHash != null && Object.hasOwnProperty.call(message, "sessionHash"))
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ShareCovertComponents.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        ShareCovertComponents.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.ShareCovertComponents();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        ShareCovertComponents.verify = function verify(message) {
            ...
            if (message.components != null && message.hasOwnProperty("components")) {
                ...
                for (var i = 0; i < message.components.length; ++i)
                    if (!(message.components[i] && typeof message.components[i].length === "number" || $util.isString(message.components[i])))
                        return "components: buffer[] expected";
            }
            if (message.skipSignatures != null && message.hasOwnProperty("skipSignatures"))
            ...
            if (message.sessionHash != null && message.hasOwnProperty("sessionHash"))
                if (!(message.sessionHash && typeof message.sessionHash.length === "number" || $util.isString(message.sessionHash)))
        ...
        ShareCovertComponents.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.ShareCovertComponents)
                return object;
            var message = new $root.fusion.ShareCovertComponents();
            if (object.components) {
                if (!Array.isArray(object.components))
                    throw TypeError(".fusion.ShareCovertComponents.components: array expected");
                message.components = [];
                for (var i = 0; i < object.components.length; ++i)
                    if (typeof object.components[i] === "string")
                        $util.base64.decode(object.components[i], message.components[i] = $util.newBuffer($util.base64.length(object.components[i])), 0);
            ...
            if (object.sessionHash != null)
                if (typeof object.sessionHash === "string")
                    $util.base64.decode(object.sessionHash, message.sessionHash = $util.newBuffer($util.base64.length(object.sessionHash)), 0);
        ...
        ShareCovertComponents.toObject = function toObject(message, options) {
            ...
            if (message.components && message.components.length) {
                ...
                for (var j = 0; j < message.components.length; ++j)
                    object.components[j] = options.bytes === String ? $util.base64.encode(message.components[j], 0, message.components[j].length) : options.bytes === Array ? Array.prototype.slice.call(message.components[j]) : message.components[j];
            }
            if (message.skipSignatures != null && message.hasOwnProperty("skipSignatures"))
                object.skipSignatures = message.skipSignatures;
            if (message.sessionHash != null && message.hasOwnProperty("sessionHash"))
                object.sessionHash = options.bytes === String ? $util.base64.encode(message.sessionHash, 0, message.sessionHash.length) : options.bytes === Array ? Array.prototype.slice.call(message.sessionHash) : message.sessionHash;
            return object;
        };
    ...
    fusion.CovertTransactionSignature = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CovertTransactionSignature.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        CovertTransactionSignature.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.CovertTransactionSignature();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
            ...
            if (!message.hasOwnProperty("whichInput"))
                throw $util.ProtocolError("missing required 'whichInput'", { instance: message });
            if (!message.hasOwnProperty("txsignature"))
                throw $util.ProtocolError("missing required 'txsignature'", { instance: message });
            return message;
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CovertTransactionSignature.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        CovertTransactionSignature.verify = function verify(message) {
            ...
            if (!(message.txsignature && typeof message.txsignature.length === "number" || $util.isString(message.txsignature)))
        ...
        CovertTransactionSignature.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.CovertTransactionSignature)
                return object;
            var message = new $root.fusion.CovertTransactionSignature();
            if (object.roundPubkey != null)
                if (typeof object.roundPubkey === "string")
                    $util.base64.decode(object.roundPubkey, message.roundPubkey = $util.newBuffer($util.base64.length(object.roundPubkey)), 0);
                else if (object.roundPubkey.length >= 0)
            ...
            if (object.txsignature != null)
                if (typeof object.txsignature === "string")
                    $util.base64.decode(object.txsignature, message.txsignature = $util.newBuffer($util.base64.length(object.txsignature)), 0);
        ...
        CovertTransactionSignature.toObject = function toObject(message, options) {
            ...
            if (message.txsignature != null && message.hasOwnProperty("txsignature"))
                object.txsignature = options.bytes === String ? $util.base64.encode(message.txsignature, 0, message.txsignature.length) : options.bytes === Array ? Array.prototype.slice.call(message.txsignature) : message.txsignature;
            return object;
        };
    ...
    fusion.FusionResult = (function() {
        ...
        FusionResult.encode = function encode(message, writer) {
            ...
            if (message.txsignatures != null && message.txsignatures.length)
                for (var i = 0; i < message.txsignatures.length; ++i)
                    writer.uint32(/* id 2, wireType 2 =*/18).bytes(message.txsignatures[i]);
            if (message.badComponents != null && message.badComponents.length)
                for (var i = 0; i < message.badComponents.length; ++i)
                    writer.uint32(/* id 3, wireType 0 =*/24).uint32(message.badComponents[i]);
            return writer;
        };
        ...
        FusionResult.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.FusionResult();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        FusionResult.verify = function verify(message) {
            ...
            if (message.txsignatures != null && message.hasOwnProperty("txsignatures")) {
                if (!Array.isArray(message.txsignatures))
                    return "txsignatures: array expected";
                for (var i = 0; i < message.txsignatures.length; ++i)
                    if (!(message.txsignatures[i] && typeof message.txsignatures[i].length === "number" || $util.isString(message.txsignatures[i])))
                        return "txsignatures: buffer[] expected";
            }
            if (message.badComponents != null && message.hasOwnProperty("badComponents")) {
        ...
        FusionResult.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.FusionResult)
                return object;
            var message = new $root.fusion.FusionResult();
            if (object.ok != null)
            ...
            if (object.txsignatures) {
                ...
                message.txsignatures = [];
                for (var i = 0; i < object.txsignatures.length; ++i)
                    if (typeof object.txsignatures[i] === "string")
                        $util.base64.decode(object.txsignatures[i], message.txsignatures[i] = $util.newBuffer($util.base64.length(object.txsignatures[i])), 0);
            ...
            if (object.badComponents) {
                ...
                message.badComponents = [];
                for (var i = 0; i < object.badComponents.length; ++i)
        ...
        FusionResult.toObject = function toObject(message, options) {
            ...
            if (message.txsignatures && message.txsignatures.length) {
                object.txsignatures = [];
                for (var j = 0; j < message.txsignatures.length; ++j)
                    object.txsignatures[j] = options.bytes === String ? $util.base64.encode(message.txsignatures[j], 0, message.txsignatures[j].length) : options.bytes === Array ? Array.prototype.slice.call(message.txsignatures[j]) : message.txsignatures[j];
            }
            if (message.badComponents && message.badComponents.length) {
                object.badComponents = [];
                for (var j = 0; j < message.badComponents.length; ++j)
    ...
    fusion.MyProofsList = (function() {
        ...
        MyProofsList.encode = function encode(message, writer) {
            ...
            if (message.encryptedProofs != null && message.encryptedProofs.length)
                for (var i = 0; i < message.encryptedProofs.length; ++i)
                    writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.encryptedProofs[i]);
        ...
        MyProofsList.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.MyProofsList();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
            ...
            if (!message.hasOwnProperty("randomNumber"))
                throw $util.ProtocolError("missing required 'randomNumber'", { instance: message });
            return message;
        };
        ...
        MyProofsList.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.encryptedProofs != null && message.hasOwnProperty("encryptedProofs")) {
                if (!Array.isArray(message.encryptedProofs))
                    return "encryptedProofs: array expected";
                for (var i = 0; i < message.encryptedProofs.length; ++i)
                    if (!(message.encryptedProofs[i] && typeof message.encryptedProofs[i].length === "number" || $util.isString(message.encryptedProofs[i])))
        ...
        MyProofsList.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.MyProofsList)
                return object;
            var message = new $root.fusion.MyProofsList();
            if (object.encryptedProofs) {
                if (!Array.isArray(object.encryptedProofs))
                    throw TypeError(".fusion.MyProofsList.encryptedProofs: array expected");
                message.encryptedProofs = [];
                for (var i = 0; i < object.encryptedProofs.length; ++i)
                    if (typeof object.encryptedProofs[i] === "string")
                        $util.base64.decode(object.encryptedProofs[i], message.encryptedProofs[i] = $util.newBuffer($util.base64.length(object.encryptedProofs[i])), 0);
        ...
        MyProofsList.toObject = function toObject(message, options) {
            ...
            if (message.encryptedProofs && message.encryptedProofs.length) {
                object.encryptedProofs = [];
                for (var j = 0; j < message.encryptedProofs.length; ++j)
                    object.encryptedProofs[j] = options.bytes === String ? $util.base64.encode(message.encryptedProofs[j], 0, message.encryptedProofs[j].length) : options.bytes === Array ? Array.prototype.slice.call(message.encryptedProofs[j]) : message.encryptedProofs[j];
            }
    ...
    fusion.TheirProofsList = (function() {
        ...
        TheirProofsList.encode = function encode(message, writer) {
            ...
            if (message.proofs != null && message.proofs.length)
                for (var i = 0; i < message.proofs.length; ++i)
                    $root.fusion.TheirProofsList.RelayedProof.encode(message.proofs[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        TheirProofsList.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        TheirProofsList.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.TheirProofsList();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 1: {
                        if (!(message.proofs && message.proofs.length))
                            message.proofs = [];
                        message.proofs.push($root.fusion.TheirProofsList.RelayedProof.decode(reader, reader.uint32()));
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        TheirProofsList.verify = function verify(message) {
            ...
            if (message.proofs != null && message.hasOwnProperty("proofs")) {
                ...
                for (var i = 0; i < message.proofs.length; ++i) {
                    var error = $root.fusion.TheirProofsList.RelayedProof.verify(message.proofs[i]);
                    if (error)
                        return "proofs." + error;
                }
            }
        ...
        TheirProofsList.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.TheirProofsList)
                return object;
            var message = new $root.fusion.TheirProofsList();
            if (object.proofs) {
                ...
                for (var i = 0; i < object.proofs.length; ++i) {
                    ...
                    message.proofs[i] = $root.fusion.TheirProofsList.RelayedProof.fromObject(object.proofs[i]);
                }
            }
            return message;
        };
        ...
        TheirProofsList.toObject = function toObject(message, options) {
            ...
            if (message.proofs && message.proofs.length) {
                ...
                for (var j = 0; j < message.proofs.length; ++j)
                    object.proofs[j] = $root.fusion.TheirProofsList.RelayedProof.toObject(message.proofs[j], options);
            }
            return object;
        };
        ...
        TheirProofsList.RelayedProof = (function() {
            ...
            RelayedProof.encode = function encode(message, writer) {
                ...
                writer.uint32(/* id 2, wireType 0 =*/16).uint32(message.srcCommitmentIdx);
            ...
            RelayedProof.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.TheirProofsList.RelayedProof();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
                ...
                if (!message.hasOwnProperty("encryptedProof"))
                    throw $util.ProtocolError("missing required 'encryptedProof'", { instance: message });
                if (!message.hasOwnProperty("srcCommitmentIdx"))
                    throw $util.ProtocolError("missing required 'srcCommitmentIdx'", { instance: message });
                if (!message.hasOwnProperty("dstKeyIdx"))
                    throw $util.ProtocolError("missing required 'dstKeyIdx'", { instance: message });
                return message;
            };
            ...
            RelayedProof.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (!(message.encryptedProof && typeof message.encryptedProof.length === "number" || $util.isString(message.encryptedProof)))
            ...
            RelayedProof.fromObject = function fromObject(object) {
                if (object instanceof $root.fusion.TheirProofsList.RelayedProof)
                    return object;
                var message = new $root.fusion.TheirProofsList.RelayedProof();
                if (object.encryptedProof != null)
                    if (typeof object.encryptedProof === "string")
                        $util.base64.decode(object.encryptedProof, message.encryptedProof = $util.newBuffer($util.base64.length(object.encryptedProof)), 0);
            ...
            RelayedProof.toObject = function toObject(message, options) {
                ...
                if (message.encryptedProof != null && message.hasOwnProperty("encryptedProof"))
                    object.encryptedProof = options.bytes === String ? $util.base64.encode(message.encryptedProof, 0, message.encryptedProof.length) : options.bytes === Array ? Array.prototype.slice.call(message.encryptedProof) : message.encryptedProof;
                if (message.srcCommitmentIdx != null && message.hasOwnProperty("srcCommitmentIdx"))
    ...
    fusion.Blames = (function() {
        ...
        Blames.encode = function encode(message, writer) {
            ...
            if (message.blames != null && message.blames.length)
                for (var i = 0; i < message.blames.length; ++i)
                    $root.fusion.Blames.BlameProof.encode(message.blames[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
        ...
        Blames.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.Blames();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 1: {
                        if (!(message.blames && message.blames.length))
                            message.blames = [];
                        message.blames.push($root.fusion.Blames.BlameProof.decode(reader, reader.uint32()));
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        Blames.verify = function verify(message) {
            ...
            if (message.blames != null && message.hasOwnProperty("blames")) {
                if (!Array.isArray(message.blames))
                    return "blames: array expected";
                for (var i = 0; i < message.blames.length; ++i) {
                    var error = $root.fusion.Blames.BlameProof.verify(message.blames[i]);
                    if (error)
                        return "blames." + error;
                }
            }
        ...
        Blames.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.Blames)
                return object;
            var message = new $root.fusion.Blames();
            if (object.blames) {
                if (!Array.isArray(object.blames))
                    throw TypeError(".fusion.Blames.blames: array expected");
                message.blames = [];
                for (var i = 0; i < object.blames.length; ++i) {
                    if (typeof object.blames[i] !== "object")
                        throw TypeError(".fusion.Blames.blames: object expected");
                    message.blames[i] = $root.fusion.Blames.BlameProof.fromObject(object.blames[i]);
                }
            }
            return message;
        };
        ...
        Blames.toObject = function toObject(message, options) {
            ...
            if (message.blames && message.blames.length) {
                object.blames = [];
                for (var j = 0; j < message.blames.length; ++j)
                    object.blames[j] = $root.fusion.Blames.BlameProof.toObject(message.blames[j], options);
            }
            return object;
        };
        ...
        Blames.BlameProof = (function() {
            ...
            BlameProof.encode = function encode(message, writer) {
                ...
                if (message.needLookupBlockchain != null && Object.hasOwnProperty.call(message, "needLookupBlockchain"))
                    writer.uint32(/* id 4, wireType 0 =*/32).bool(message.needLookupBlockchain);
                if (message.blameReason != null && Object.hasOwnProperty.call(message, "blameReason"))
            ...
            BlameProof.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.Blames.BlameProof();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
                ...
                if (!message.hasOwnProperty("whichProof"))
                    throw $util.ProtocolError("missing required 'whichProof'", { instance: message });
                return message;
            };
            ...
            BlameProof.fromObject = function fromObject(object) {
                if (object instanceof $root.fusion.Blames.BlameProof)
                    return object;
                var message = new $root.fusion.Blames.BlameProof();
    ...
    fusion.RestartRound = (function() {
        ...
        RestartRound.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.RestartRound();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        RestartRound.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.RestartRound)
                return object;
    ...
    fusion.Error = (function() {
        ...
        Error.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.Error();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        Error.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.Error)
                return object;
            var message = new $root.fusion.Error();
    ...
    fusion.Ping = (function() {
        ...
        Ping.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.Ping();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        Ping.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.Ping)
                return object;
    ...
    fusion.OK = (function() {
        ...
        OK.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.OK();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        OK.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.OK)
                return object;
    ...
    fusion.ClientMessage = (function() {
        ...
        Object.defineProperty(ClientMessage.prototype, "msg", {
            get: $util.oneOfGetter($oneOfFields = ["clienthello", "joinpools", "playercommit", "myproofslist", "blames"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        ClientMessage.encode = function encode(message, writer) {
            ...
            if (message.clienthello != null && Object.hasOwnProperty.call(message, "clienthello"))
                $root.fusion.ClientHello.encode(message.clienthello, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.joinpools != null && Object.hasOwnProperty.call(message, "joinpools"))
                $root.fusion.JoinPools.encode(message.joinpools, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.playercommit != null && Object.hasOwnProperty.call(message, "playercommit"))
                $root.fusion.PlayerCommit.encode(message.playercommit, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.myproofslist != null && Object.hasOwnProperty.call(message, "myproofslist"))
                $root.fusion.MyProofsList.encode(message.myproofslist, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            if (message.blames != null && Object.hasOwnProperty.call(message, "blames"))
                $root.fusion.Blames.encode(message.blames, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
            return writer;
        };
        ...
        ClientMessage.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.ClientMessage();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.clienthello = $root.fusion.ClientHello.decode(reader, reader.uint32());
                        break;
                    }
                case 2: {
                        message.joinpools = $root.fusion.JoinPools.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
                        message.playercommit = $root.fusion.PlayerCommit.decode(reader, reader.uint32());
                        break;
                    }
                case 5: {
                        message.myproofslist = $root.fusion.MyProofsList.decode(reader, reader.uint32());
                        break;
                    }
                case 6: {
                        message.blames = $root.fusion.Blames.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        ClientMessage.verify = function verify(message) {
            ...
            if (message.clienthello != null && message.hasOwnProperty("clienthello")) {
                properties.msg = 1;
                {
                    var error = $root.fusion.ClientHello.verify(message.clienthello);
                    if (error)
            ...
            if (message.joinpools != null && message.hasOwnProperty("joinpools")) {
                ...
                properties.msg = 1;
                {
                    var error = $root.fusion.JoinPools.verify(message.joinpools);
                    if (error)
                        return "joinpools." + error;
                }
            }
            if (message.playercommit != null && message.hasOwnProperty("playercommit")) {
                if (properties.msg === 1)
                    return "msg: multiple values";
                properties.msg = 1;
                {
                    var error = $root.fusion.PlayerCommit.verify(message.playercommit);
                    if (error)
                        return "playercommit." + error;
                }
            }
            if (message.myproofslist != null && message.hasOwnProperty("myproofslist")) {
                if (properties.msg === 1)
                    return "msg: multiple values";
                properties.msg = 1;
                {
                    var error = $root.fusion.MyProofsList.verify(message.myproofslist);
                    if (error)
                        return "myproofslist." + error;
                }
            }
            if (message.blames != null && message.hasOwnProperty("blames")) {
                if (properties.msg === 1)
                ...
                properties.msg = 1;
                {
                    var error = $root.fusion.Blames.verify(message.blames);
                    if (error)
                        return "blames." + error;
                }
            }
        ...
        ClientMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.ClientMessage)
                return object;
            var message = new $root.fusion.ClientMessage();
            if (object.clienthello != null) {
                ...
                message.clienthello = $root.fusion.ClientHello.fromObject(object.clienthello);
            }
            ...
            if (object.playercommit != null) {
                if (typeof object.playercommit !== "object")
                    throw TypeError(".fusion.ClientMessage.playercommit: object expected");
                message.playercommit = $root.fusion.PlayerCommit.fromObject(object.playercommit);
            }
            if (object.myproofslist != null) {
                if (typeof object.myproofslist !== "object")
                    throw TypeError(".fusion.ClientMessage.myproofslist: object expected");
                message.myproofslist = $root.fusion.MyProofsList.fromObject(object.myproofslist);
            }
        ...
        ClientMessage.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (message.clienthello != null && message.hasOwnProperty("clienthello")) {
                object.clienthello = $root.fusion.ClientHello.toObject(message.clienthello, options);
                if (options.oneofs)
                    object.msg = "clienthello";
            }
            if (message.joinpools != null && message.hasOwnProperty("joinpools")) {
                object.joinpools = $root.fusion.JoinPools.toObject(message.joinpools, options);
                if (options.oneofs)
                    object.msg = "joinpools";
            }
            if (message.playercommit != null && message.hasOwnProperty("playercommit")) {
                object.playercommit = $root.fusion.PlayerCommit.toObject(message.playercommit, options);
                if (options.oneofs)
                    object.msg = "playercommit";
            }
            if (message.myproofslist != null && message.hasOwnProperty("myproofslist")) {
                object.myproofslist = $root.fusion.MyProofsList.toObject(message.myproofslist, options);
                if (options.oneofs)
                    object.msg = "myproofslist";
            }
            if (message.blames != null && message.hasOwnProperty("blames")) {
    ...
    fusion.ServerMessage = (function() {
        ...
        Object.defineProperty(ServerMessage.prototype, "msg", {
            get: $util.oneOfGetter($oneOfFields = ["serverhello", "tierstatusupdate", "fusionbegin", "startround", "blindsigresponses", "allcommitments", "sharecovertcomponents", "fusionresult", "theirproofslist", "restartround", "error"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        ServerMessage.encode = function encode(message, writer) {
            ...
            if (message.serverhello != null && Object.hasOwnProperty.call(message, "serverhello"))
                $root.fusion.ServerHello.encode(message.serverhello, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.tierstatusupdate != null && Object.hasOwnProperty.call(message, "tierstatusupdate"))
                $root.fusion.TierStatusUpdate.encode(message.tierstatusupdate, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.fusionbegin != null && Object.hasOwnProperty.call(message, "fusionbegin"))
                $root.fusion.FusionBegin.encode(message.fusionbegin, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.startround != null && Object.hasOwnProperty.call(message, "startround"))
                $root.fusion.StartRound.encode(message.startround, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.blindsigresponses != null && Object.hasOwnProperty.call(message, "blindsigresponses"))
                $root.fusion.BlindSigResponses.encode(message.blindsigresponses, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            if (message.allcommitments != null && Object.hasOwnProperty.call(message, "allcommitments"))
                $root.fusion.AllCommitments.encode(message.allcommitments, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
            if (message.sharecovertcomponents != null && Object.hasOwnProperty.call(message, "sharecovertcomponents"))
                $root.fusion.ShareCovertComponents.encode(message.sharecovertcomponents, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
            if (message.fusionresult != null && Object.hasOwnProperty.call(message, "fusionresult"))
                $root.fusion.FusionResult.encode(message.fusionresult, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
            if (message.theirproofslist != null && Object.hasOwnProperty.call(message, "theirproofslist"))
                $root.fusion.TheirProofsList.encode(message.theirproofslist, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
            if (message.restartround != null && Object.hasOwnProperty.call(message, "restartround"))
                $root.fusion.RestartRound.encode(message.restartround, writer.uint32(/* id 14, wireType 2 =*/114).fork()).ldelim();
            if (message.error != null && Object.hasOwnProperty.call(message, "error"))
                $root.fusion.Error.encode(message.error, writer.uint32(/* id 15, wireType 2 =*/122).fork()).ldelim();
            return writer;
        };
        ...
        ServerMessage.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.ServerMessage();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.serverhello = $root.fusion.ServerHello.decode(reader, reader.uint32());
                        break;
                    }
                case 2: {
                        message.tierstatusupdate = $root.fusion.TierStatusUpdate.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
                        message.fusionbegin = $root.fusion.FusionBegin.decode(reader, reader.uint32());
                        break;
                    }
                case 4: {
                        message.startround = $root.fusion.StartRound.decode(reader, reader.uint32());
                        break;
                    }
                case 5: {
                        message.blindsigresponses = $root.fusion.BlindSigResponses.decode(reader, reader.uint32());
                        break;
                    }
                case 6: {
                        message.allcommitments = $root.fusion.AllCommitments.decode(reader, reader.uint32());
                        break;
                    }
                case 7: {
                        message.sharecovertcomponents = $root.fusion.ShareCovertComponents.decode(reader, reader.uint32());
                        break;
                    }
                case 8: {
                        message.fusionresult = $root.fusion.FusionResult.decode(reader, reader.uint32());
                        break;
                    }
                case 9: {
                        message.theirproofslist = $root.fusion.TheirProofsList.decode(reader, reader.uint32());
                        break;
                    }
                case 14: {
                        message.restartround = $root.fusion.RestartRound.decode(reader, reader.uint32());
                        break;
                    }
                case 15: {
        ...
        ServerMessage.verify = function verify(message) {
            ...
            if (message.serverhello != null && message.hasOwnProperty("serverhello")) {
                properties.msg = 1;
                {
                    var error = $root.fusion.ServerHello.verify(message.serverhello);
                    if (error)
                        return "serverhello." + error;
                }
            }
            if (message.tierstatusupdate != null && message.hasOwnProperty("tierstatusupdate")) {
                if (properties.msg === 1)
                    return "msg: multiple values";
                properties.msg = 1;
                {
                    var error = $root.fusion.TierStatusUpdate.verify(message.tierstatusupdate);
                    if (error)
                        return "tierstatusupdate." + error;
                }
            }
            if (message.fusionbegin != null && message.hasOwnProperty("fusionbegin")) {
                if (properties.msg === 1)
                    return "msg: multiple values";
                properties.msg = 1;
                {
                    var error = $root.fusion.FusionBegin.verify(message.fusionbegin);
                    if (error)
                        return "fusionbegin." + error;
                }
            }
            if (message.startround != null && message.hasOwnProperty("startround")) {
                ...
                properties.msg = 1;
                {
                    var error = $root.fusion.StartRound.verify(message.startround);
                    if (error)
                        return "startround." + error;
                }
            }
            if (message.blindsigresponses != null && message.hasOwnProperty("blindsigresponses")) {
                if (properties.msg === 1)
                    return "msg: multiple values";
                properties.msg = 1;
                {
                    var error = $root.fusion.BlindSigResponses.verify(message.blindsigresponses);
                    if (error)
                        return "blindsigresponses." + error;
                }
            }
            if (message.allcommitments != null && message.hasOwnProperty("allcommitments")) {
                if (properties.msg === 1)
                    return "msg: multiple values";
                properties.msg = 1;
                {
                    var error = $root.fusion.AllCommitments.verify(message.allcommitments);
                    if (error)
                        return "allcommitments." + error;
                }
            }
            if (message.sharecovertcomponents != null && message.hasOwnProperty("sharecovertcomponents")) {
                if (properties.msg === 1)
                    return "msg: multiple values";
                properties.msg = 1;
                {
                    var error = $root.fusion.ShareCovertComponents.verify(message.sharecovertcomponents);
                    if (error)
                        return "sharecovertcomponents." + error;
                }
            }
            if (message.fusionresult != null && message.hasOwnProperty("fusionresult")) {
                if (properties.msg === 1)
                    return "msg: multiple values";
                properties.msg = 1;
                {
                    var error = $root.fusion.FusionResult.verify(message.fusionresult);
                    if (error)
                        return "fusionresult." + error;
                }
            }
            if (message.theirproofslist != null && message.hasOwnProperty("theirproofslist")) {
                if (properties.msg === 1)
                    return "msg: multiple values";
                properties.msg = 1;
                {
                    var error = $root.fusion.TheirProofsList.verify(message.theirproofslist);
                    if (error)
                        return "theirproofslist." + error;
                }
            }
            if (message.restartround != null && message.hasOwnProperty("restartround")) {
                if (properties.msg === 1)
                    return "msg: multiple values";
                properties.msg = 1;
                {
                    var error = $root.fusion.RestartRound.verify(message.restartround);
                    if (error)
                        return "restartround." + error;
                }
            }
            if (message.error != null && message.hasOwnProperty("error")) {
                ...
                properties.msg = 1;
                {
                    var error = $root.fusion.Error.verify(message.error);
                    if (error)
                        return "error." + error;
                }
            }
        ...
        ServerMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.ServerMessage)
                return object;
            var message = new $root.fusion.ServerMessage();
            if (object.serverhello != null) {
                ...
                message.serverhello = $root.fusion.ServerHello.fromObject(object.serverhello);
            }
            if (object.tierstatusupdate != null) {
                if (typeof object.tierstatusupdate !== "object")
                    throw TypeError(".fusion.ServerMessage.tierstatusupdate: object expected");
                message.tierstatusupdate = $root.fusion.TierStatusUpdate.fromObject(object.tierstatusupdate);
            }
            if (object.fusionbegin != null) {
                ...
                message.fusionbegin = $root.fusion.FusionBegin.fromObject(object.fusionbegin);
            }
            if (object.startround != null) {
                ...
                message.startround = $root.fusion.StartRound.fromObject(object.startround);
            }
            if (object.blindsigresponses != null) {
                if (typeof object.blindsigresponses !== "object")
                    throw TypeError(".fusion.ServerMessage.blindsigresponses: object expected");
                message.blindsigresponses = $root.fusion.BlindSigResponses.fromObject(object.blindsigresponses);
            }
            if (object.allcommitments != null) {
                if (typeof object.allcommitments !== "object")
                    throw TypeError(".fusion.ServerMessage.allcommitments: object expected");
                message.allcommitments = $root.fusion.AllCommitments.fromObject(object.allcommitments);
            }
            if (object.sharecovertcomponents != null) {
                if (typeof object.sharecovertcomponents !== "object")
                    throw TypeError(".fusion.ServerMessage.sharecovertcomponents: object expected");
                message.sharecovertcomponents = $root.fusion.ShareCovertComponents.fromObject(object.sharecovertcomponents);
            }
            if (object.fusionresult != null) {
                if (typeof object.fusionresult !== "object")
                    throw TypeError(".fusion.ServerMessage.fusionresult: object expected");
                message.fusionresult = $root.fusion.FusionResult.fromObject(object.fusionresult);
            }
            if (object.theirproofslist != null) {
                if (typeof object.theirproofslist !== "object")
                    throw TypeError(".fusion.ServerMessage.theirproofslist: object expected");
                message.theirproofslist = $root.fusion.TheirProofsList.fromObject(object.theirproofslist);
            }
            if (object.restartround != null) {
                if (typeof object.restartround !== "object")
                    throw TypeError(".fusion.ServerMessage.restartround: object expected");
                message.restartround = $root.fusion.RestartRound.fromObject(object.restartround);
            }
        ...
        ServerMessage.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (message.serverhello != null && message.hasOwnProperty("serverhello")) {
                object.serverhello = $root.fusion.ServerHello.toObject(message.serverhello, options);
                if (options.oneofs)
                    object.msg = "serverhello";
            }
            if (message.tierstatusupdate != null && message.hasOwnProperty("tierstatusupdate")) {
                object.tierstatusupdate = $root.fusion.TierStatusUpdate.toObject(message.tierstatusupdate, options);
                if (options.oneofs)
                    object.msg = "tierstatusupdate";
            }
            if (message.fusionbegin != null && message.hasOwnProperty("fusionbegin")) {
                object.fusionbegin = $root.fusion.FusionBegin.toObject(message.fusionbegin, options);
                if (options.oneofs)
                    object.msg = "fusionbegin";
            }
            if (message.startround != null && message.hasOwnProperty("startround")) {
                object.startround = $root.fusion.StartRound.toObject(message.startround, options);
                if (options.oneofs)
                    object.msg = "startround";
            }
            if (message.blindsigresponses != null && message.hasOwnProperty("blindsigresponses")) {
                object.blindsigresponses = $root.fusion.BlindSigResponses.toObject(message.blindsigresponses, options);
                if (options.oneofs)
                    object.msg = "blindsigresponses";
            }
            if (message.allcommitments != null && message.hasOwnProperty("allcommitments")) {
                object.allcommitments = $root.fusion.AllCommitments.toObject(message.allcommitments, options);
                if (options.oneofs)
                    object.msg = "allcommitments";
            }
            if (message.sharecovertcomponents != null && message.hasOwnProperty("sharecovertcomponents")) {
                object.sharecovertcomponents = $root.fusion.ShareCovertComponents.toObject(message.sharecovertcomponents, options);
                if (options.oneofs)
                    object.msg = "sharecovertcomponents";
            }
            if (message.fusionresult != null && message.hasOwnProperty("fusionresult")) {
                object.fusionresult = $root.fusion.FusionResult.toObject(message.fusionresult, options);
                if (options.oneofs)
                    object.msg = "fusionresult";
            }
            if (message.theirproofslist != null && message.hasOwnProperty("theirproofslist")) {
                object.theirproofslist = $root.fusion.TheirProofsList.toObject(message.theirproofslist, options);
                if (options.oneofs)
                    object.msg = "theirproofslist";
            }
            if (message.restartround != null && message.hasOwnProperty("restartround")) {
                object.restartround = $root.fusion.RestartRound.toObject(message.restartround, options);
                if (options.oneofs)
                    object.msg = "restartround";
            }
            if (message.error != null && message.hasOwnProperty("error")) {
    ...
    fusion.CovertMessage = (function() {
        ...
        Object.defineProperty(CovertMessage.prototype, "msg", {
            get: $util.oneOfGetter($oneOfFields = ["component", "signature", "ping"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        CovertMessage.encode = function encode(message, writer) {
            ...
            if (message.component != null && Object.hasOwnProperty.call(message, "component"))
                $root.fusion.CovertComponent.encode(message.component, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.signature != null && Object.hasOwnProperty.call(message, "signature"))
                $root.fusion.CovertTransactionSignature.encode(message.signature, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.ping != null && Object.hasOwnProperty.call(message, "ping"))
                $root.fusion.Ping.encode(message.ping, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };
        ...
        CovertMessage.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.CovertMessage();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.component = $root.fusion.CovertComponent.decode(reader, reader.uint32());
                        break;
                    }
                case 2: {
                        message.signature = $root.fusion.CovertTransactionSignature.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
        ...
        CovertMessage.verify = function verify(message) {
            ...
            if (message.component != null && message.hasOwnProperty("component")) {
                properties.msg = 1;
                {
                    var error = $root.fusion.CovertComponent.verify(message.component);
                    if (error)
            ...
            if (message.signature != null && message.hasOwnProperty("signature")) {
                ...
                properties.msg = 1;
                {
                    var error = $root.fusion.CovertTransactionSignature.verify(message.signature);
                    if (error)
            ...
            if (message.ping != null && message.hasOwnProperty("ping")) {
                ...
                properties.msg = 1;
                {
                    var error = $root.fusion.Ping.verify(message.ping);
                    if (error)
                        return "ping." + error;
                }
            }
        ...
        CovertMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.CovertMessage)
                return object;
            var message = new $root.fusion.CovertMessage();
            if (object.component != null) {
                if (typeof object.component !== "object")
                    throw TypeError(".fusion.CovertMessage.component: object expected");
                message.component = $root.fusion.CovertComponent.fromObject(object.component);
            }
            if (object.signature != null) {
                if (typeof object.signature !== "object")
                    throw TypeError(".fusion.CovertMessage.signature: object expected");
                message.signature = $root.fusion.CovertTransactionSignature.fromObject(object.signature);
            }
            if (object.ping != null) {
        ...
        CovertMessage.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (message.component != null && message.hasOwnProperty("component")) {
                object.component = $root.fusion.CovertComponent.toObject(message.component, options);
                if (options.oneofs)
                    object.msg = "component";
            }
            if (message.signature != null && message.hasOwnProperty("signature")) {
                object.signature = $root.fusion.CovertTransactionSignature.toObject(message.signature, options);
                if (options.oneofs)
                    object.msg = "signature";
            }
            if (message.ping != null && message.hasOwnProperty("ping")) {
    ...
    fusion.CovertResponse = (function() {
        ...
        CovertResponse.encode = function encode(message, writer) {
            ...
            if (message.ok != null && Object.hasOwnProperty.call(message, "ok"))
                $root.fusion.OK.encode(message.ok, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.error != null && Object.hasOwnProperty.call(message, "error"))
                $root.fusion.Error.encode(message.error, writer.uint32(/* id 15, wireType 2 =*/122).fork()).ldelim();
            return writer;
        };
        ...
        CovertResponse.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fusion.CovertResponse();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        CovertResponse.verify = function verify(message) {
            ...
            if (message.ok != null && message.hasOwnProperty("ok")) {
                properties.msg = 1;
                {
                    var error = $root.fusion.OK.verify(message.ok);
                    if (error)
                        return "ok." + error;
                }
            }
        ...
        CovertResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.fusion.CovertResponse)
                return object;
            var message = new $root.fusion.CovertResponse();
            if (object.ok != null) {
